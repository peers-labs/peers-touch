...
class Attachment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'peers_touch.model.activity.v1'),
...
class ActivityInput extends $pb.GeneratedMessage {
  factory ActivityInput({
    $core.String? text,
  ...
  factory ActivityInput.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ActivityInput.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ActivityInput',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'peers_touch.model.activity.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'text')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ActivityInput clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ActivityInput copyWith(void Function(ActivityInput) updates) =>
      super.copyWith((message) => updates(message as ActivityInput))
          as ActivityInput;
  ...
  @$core.pragma('dart2js:noInline')
  static ActivityInput create() => ActivityInput._();
  @$core.override
  ActivityInput createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ActivityInput getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ActivityInput>(create);
  static ActivityInput? _defaultInstance;
...
class ActivityResponse extends $pb.GeneratedMessage {
  ...
  factory ActivityResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ActivityResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ActivityResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'peers_touch.model.activity.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ActivityResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ActivityResponse copyWith(void Function(ActivityResponse) updates) =>
      super.copyWith((message) => updates(message as ActivityResponse))
          as ActivityResponse;
  ...
  @$core.pragma('dart2js:noInline')
  static ActivityResponse create() => ActivityResponse._();
  @$core.override
  ActivityResponse createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ActivityResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ActivityResponse>(create);
  static ActivityResponse? _defaultInstance;
