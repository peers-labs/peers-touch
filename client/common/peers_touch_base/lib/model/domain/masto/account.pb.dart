...
class MastoAccount extends $pb.GeneratedMessage {
  factory MastoAccount({
    $core.String? id,
  ...
  factory MastoAccount.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory MastoAccount.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MastoAccount',
  ...
  MastoAccount clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MastoAccount copyWith(void Function(MastoAccount) updates) =>
      super.copyWith((message) => updates(message as MastoAccount))
          as MastoAccount;
  ...
  static MastoAccount create() => MastoAccount._();
  @$core.override
  MastoAccount createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static MastoAccount getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MastoAccount>(create);
  static MastoAccount? _defaultInstance;
