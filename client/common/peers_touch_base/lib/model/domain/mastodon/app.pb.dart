...
class MastodonApp extends $pb.GeneratedMessage {
  factory MastodonApp({
    $core.String? id,
    $core.String? name,
  ...
  factory MastodonApp.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory MastodonApp.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MastodonApp',
  ...
  MastodonApp clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MastodonApp copyWith(void Function(MastodonApp) updates) =>
      super.copyWith((message) => updates(message as MastodonApp))
          as MastodonApp;
  ...
  static MastodonApp create() => MastodonApp._();
  @$core.override
  MastodonApp createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static MastodonApp getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MastodonApp>(create);
  static MastodonApp? _defaultInstance;
