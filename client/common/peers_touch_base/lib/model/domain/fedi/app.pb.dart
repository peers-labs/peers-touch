...
//
// Generated from domain/fedi/app.proto.
...
class FediApp extends $pb.GeneratedMessage {
  factory FediApp({
    $core.String? id,
    $core.String? name,
  ...
  factory FediApp.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory FediApp.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FediApp',
  ...
  FediApp clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FediApp copyWith(void Function(FediApp) updates) =>
      super.copyWith((message) => updates(message as FediApp)) as FediApp;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FediApp create() => FediApp._();
  @$core.override
  FediApp createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static FediApp getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FediApp>(create);
  static FediApp? _defaultInstance;
