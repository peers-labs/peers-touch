...
class FediOAuthToken extends $pb.GeneratedMessage {
  factory FediOAuthToken({
  ...
  factory FediOAuthToken.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory FediOAuthToken.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FediOAuthToken',
  ...
  FediOAuthToken clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FediOAuthToken copyWith(void Function(FediOAuthToken) updates) =>
      super.copyWith((message) => updates(message as FediOAuthToken))
          as FediOAuthToken;
  ...
  static FediOAuthToken create() => FediOAuthToken._();
  @$core.override
  FediOAuthToken createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static FediOAuthToken getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FediOAuthToken>(create);
  static FediOAuthToken? _defaultInstance;
