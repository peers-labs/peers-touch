...
class FediAccount extends $pb.GeneratedMessage {
  factory FediAccount({
    $core.String? id,
  ...
  factory FediAccount.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory FediAccount.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FediAccount',
  ...
  FediAccount clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FediAccount copyWith(void Function(FediAccount) updates) =>
      super.copyWith((message) => updates(message as FediAccount))
          as FediAccount;
  ...
  static FediAccount create() => FediAccount._();
  @$core.override
  FediAccount createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static FediAccount getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FediAccount>(create);
  static FediAccount? _defaultInstance;
