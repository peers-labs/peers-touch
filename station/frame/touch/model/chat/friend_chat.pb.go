...
type CreateSessionResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Session       *FriendChatSession     `protobuf:"bytes,1,opt,name=session,proto3" json:"session,omitempty"`
...
func (x *MessageAckRequest) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *PendingMessageInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PendingMessageInfo) GetSessionUlid() string {
	if x != nil {
		return x.SessionUlid
	}
	return ""
...
func (x *PendingMessageInfo) GetEncryptedPayload() []byte {
	if x != nil {
		return x.EncryptedPayload
	}
	return nil
...
func (x *PendingMessageInfo) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
type GetPendingResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Messages      []*PendingMessageInfo  `protobuf:"bytes,1,rep,name=messages,proto3" json:"messages,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_domain_chat_friend_chat_proto_rawDesc = "" +
	...
	"\x06failed\x18\x02 \x03(\tR\x06failed\"A\n" +
