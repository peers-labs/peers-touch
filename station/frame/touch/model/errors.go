...
var (
	...
	ErrActorInvalidName               = NewError("t10003", "invalid name")
	ErrActorInvalidEmail              = NewError("t10004", "invalid email")
	ErrActorInvalidPassword           = NewError("t10005", "invalid password")
	ErrActorActorExists               = NewError("t10006", "actor already exists")
	ErrActorInvalidPassport           = NewError("t10007", "invalid passport")
